...
\chead{}
\rhead{Задачный минимум к контрольной \textnumero 2 по ТВ и МС}
\lfoot{}
\cfoot{}
...
\item $0.125   $
\item $0.5 $  
\item $f_{X}(x) = \begin{cases} x+\frac{1}{2}, & \mbox{при } x \in [0;1] \\ 0 , & \mbox{при } x \not\in [0;1] \end{cases}$  
\item $f_{Y}(y) = \begin{cases} y+\frac{1}{2}, & \mbox{при } y \in [0;1] \\ 0 , & \mbox{при } y \not\in [0;1] \end{cases}$  
\item нет  
\end{enumerate}
...
\item$f_{X}(x) = \begin{cases} 2x, & \mbox{при } x \in [0;1] \\ 0 , & \mbox{при } x \not\in [0;1] \end{cases}$  

\item$f_{Y}(y) = \begin{cases} 2y, & \mbox{при } y \in [0;1] \\ 0 , & \mbox{при } y \not\in [0;1] \end{cases}$  
...
\item $f_{X|Y}(x|\frac{1}{2}) = \begin{cases} x+\frac{1}{2}, & \mbox{при } x \in [0;1] \\ 0 , & \mbox{при } x \not\in [0;1] \end{cases}$  
...
\item $f_{X|Y}(x|\frac{1}{2}) = \begin{cases} 2x, & \mbox{при } x \in [0;1] \\ 0 , & \mbox{при } x \not\in [0;1] \end{cases}$   
